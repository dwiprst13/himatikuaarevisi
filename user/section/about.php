<section id="about" class="bg-white">
    <div class="w-[95%] mx-auto md:w-[90%] rounded-2xl p-3 md:p-5 space-y-10">
        <h2 class="text-center font-bold text-[1.6rem] md:text-[2rem] lg:text-[2.5rem] text-[#072748]">Tentang Kami</h2>
        <div class="text-gray-900 my-10 space-y-5">
            <div class="flex items-center justify-center">
                <h3 class="text-[1.2rem] md:text-[1.3rem] lg:text-[1.5rem] bg-[#072748] text-white rounded-full w-fit p-1 px-5 flex items-center shadow-xl">Profil</h3>
            </div>
        ...
        <div class="text-gray-900 my-10 space-y-5">
            <div class="flex items-center justify-center">
                <h3 class="text-[1.2rem] md:text-[1.3rem] lg:text-[1.5rem] bg-[#072748] text-white rounded-full w-fit p-1 px-5 flex items-center shadow-xl">Sejarah</h3>
            </div>
            <div class="text-center p-5 rounded-2xl">
                <p class="text-[1rem] md:text-[1.1rem] lg:text-[1.2rem] text-center">
                    <span class="text-[#072748]">HIMATIK UAA</span> merupakan organisasi intra kampus sebagai wadah kreatifitas seluruh mahasiswa Informatika Fakultas Komputer Universitas Alma Ata Yogyakarta, yang berdiri pada tanggal 21 November 2017.
                    <span class="text-[#072748]">HIMATIK UAA</span> bersifat independen yang berorientasi pada pendidikan dan pengembangan soft skill serta hard skill di bidang Informatika yang berlandaskan pada nilai nilai keislaman dan kebangsaan Indonesia
                </p>
            </div>
        </div>
        <div class="text-gray-900 my-10 space-y-5">
            <div class="flex items-center justify-center">
                <h3 class="text-[1.2rem] md:text-[1.3rem] lg:text-[1.5rem] bg-[#072748] text-white rounded-full w-fit p-1 px-5 flex items-center shadow-xl">Visi & Misi</h3>
            </div>
            <div class="flex flex-col space-y-4 md:space-y-0 md:flex-row gap-5 md:gap-3">
                <div class="w-md md:w-1/2 p-5">
                    <h4 class="font-bold text-center text-[1.3rem] py-3 text-[#072748]">Visi</h4>
                    <p class="text-[1rem] md:text-[1.1rem] lg:text-[1.2rem] text-justify">
                ...
                <div class="w-full md:w-1/2 p-5">
                    <h4 class="font-bold text-center text-[1.3rem] py-3 text-[#072748]">Misi</h4>
