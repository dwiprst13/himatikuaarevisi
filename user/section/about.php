<section id="about" class="bg-white">
    <div class="w-[95%] mx-auto md:w-[90%] rounded-2xl p-3 md:p-5 space-y-10">
        ...
        <div class="text-gray-900 my-10 space-y-5">
            <div class="flex items-center justify-center">
                <h3 class="text-[1.2rem] md:text-[1.3rem] lg:text-[1.5rem] bg-blue-700 text-white rounded-full w-fit p-1 px-5 flex items-center shadow-xl">Profil</h3>
            </div>
            <div class="flex flex-col md:flex-row md:space-x-5">
                ...
                <div class="w-full md:w-4/6 text-center py-5 space-y-[1rem]">
                    <p class="text-[1rem] md:text-[1.1rem] lg:text-[1.2rem] text-justify">
                        <span class="bg-green-600 text-white p-1 rounded-lg">Kode</span> diartikan sebagai bahasa pemrograman, yang merupakan alat utama dalam pengembangan software, aplikasi dan berbagai solusi berbasis teknologi. penggunaan kata "Kode" menggambarkan fokus organisasi pada bidang pemrograman dan teknologi informatika.
                    </p>
                    <p class="text-[1rem] md:text-[1.1rem] lg:text-[1.2rem] text-justify">
                        <span class="bg-green-600 text-white p-1 rounded-lg">Inovasi</span> merupakan konsep kunci yang menunjukkan keinginan untuk menciptakan ide-ide baru, menemukan solusi kreatif, dan terus menerus berinovasi, terutama dalam bidang teknologi dan informatika. Inovasi juga mencerminkan semangat untuk terus terus berkembang dan beradaptasi dengan perubahan zaman serta kebutuhan masyarakat.
                    </p>
                    <p class="text-[1rem] md:text-[1.1rem] lg:text-[1.2rem] text-justify">
                        <span class="bg-green-600 text-white p-1 rounded-lg">Kabinet Kode Inovasi</span> bisa diintepretasikan sebagai sebuah tim pengurus dalam himpunan mahasiswa informatika yang befokus pada pengembangan dan penerapan teknologi <span>(Kode)</span> dalam cara cara yang inovatif, menciptakan solusi baru dan memajukan komunitas mereka di bidang informatika dan teknologi, nama ini menegaskan komitmen organisasi terhadap kemajuan teknologi, pembelajaran dan penciptaan dampak positif melalui inovasi.
                    </p>
                </div>
            </div>
        </div>
        <div class="text-gray-900 my-10 space-y-5">
            <div class="flex items-center justify-center">
                <h3 class="text-[1.2rem] md:text-[1.3rem] lg:text-[1.5rem] bg-blue-700 text-white rounded-full w-fit p-1 px-5 flex items-center shadow-xl">Sejarah</h3>
            </div>
        ...
        <div class="text-gray-900 my-10 space-y-5">
            <div class="flex items-center justify-center">
                <h3 class="text-[1.2rem] md:text-[1.3rem] lg:text-[1.5rem] bg-blue-700 text-white rounded-full w-fit p-1 px-5 flex items-center shadow-xl">Visi & Misi</h3>
            </div>
            <div class="flex flex-col space-y-4 md:space-y-0 md:flex-row gap-5 md:gap-3">
                <div class="w-md md:w-1/2 p-5">
                    <h4 class="font-bold text-center text-[1.3rem] py-3 text-blue-700">Visi</h4>
                    <p class="text-[1rem] md:text-[1.1rem] lg:text-[1.2rem] text-justify">
                ...
                <div class="w-full md:w-1/2 p-5">
                    <h4 class="font-bold text-center text-[1.3rem] py-3 text-blue-700">Misi</h4>
                    <table class="w-full space-y-3 text-gray-900 text-[1rem] md:text-[1.1rem] lg:text-[1.2rem] text-justify">
                        <tr>
