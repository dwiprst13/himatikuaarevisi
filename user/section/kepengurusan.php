<section class="bg-white text-gray-900 items-center justify-center">
    <div data-aos="fade-up" data-aos-duration="1500" class="space-y-5 text-gray-900">
        <h2 class="text-center font-bold text-[1.6rem] md:text-[2rem] lg:text-[2.5rem] text-[#072748]">Kepengurusan</h2>
        <div class="text-center p-5 rounded-2xl">
            ...
            <div class="w-full flex items-center justify-center">
                <button class="w-2/12 btn-open-pengurus-card p-2 text-white rounded-full bg-[#072748] my-5">Kenali Kami Yuk</button>
