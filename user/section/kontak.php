<section class="w-[100%] mx-auto py-10 bg-gray-900">
    <div class="w-[95%] mx-auto md:w-[90%] p-3 md:p-5 flex flex-wrap">
        <div data-aos="fade-up" data-aos-duration="1500" class="w-[95%] mx-auto md:w-[50%] p-3 md:p-5">
        ...
        <div data-aos="fade-up" data-aos-duration="1500" class="w-[95%] mx-auto md:w-[50%] p-3 md:p-5">
            <h2 class="font-bold text-[1.6rem] md:text-[2rem] lg:text-[2.5rem] text-blue-700 my-5">Lokasi Kampus</h2>
            <p class="text-white">
                Ingin mengajak kerjasama dengan kami di kampus kami?
            </p>
            <div class="h-96">
                <iframe class="max-h-96 p-3 rounded-lg" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1175.152771198078!2d110.32438432735823!3d-7.818693347170108!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e7af7e2b2acea97%3A0xa3cb91d3e65407b2!2sUniversitas%20Alma%20Ata%20Yogyakarta!5e0!3m2!1sid!2sid!4v1719276313737!5m2!1sid!2sid" style="border:0; border-radius: 10px;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            </div>
        </div>
    </div>
</section>